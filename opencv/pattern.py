...
class Pattern(object):
    def __init__(self, pattern_id, cv_detector=cv.xfeatures2d.SIFT_create()):
        self._id = pattern_id
        self._img = None
    ...
    def _detect_and_compute(self):
        if self.is_empty():
            return
        self._key_points, self._descriptors = self._cv_detector.detectAndCompute(self._img, None)